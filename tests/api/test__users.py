...
#     response = client_sqlite.get(f"{settings.API_V1_STR}/users/")
...
#     user_data = {"email": "test_user@example.com", "name": "Test User", "password": "testpassword123"}
#     create_response = client_sqlite.post(f"{settings.API_V1_STR}/users/", json=user_data)
#     user_id = create_response.json()["id"]
#     response = client_sqlite.get(f"{settings.API_V1_STR}/users/{user_id}")
#     assert response.status_code == 200
#     user = response.json()
...
#     response = client_sqlite.put(f"{settings.API_V1_STR}/users/{user_id}", json=updated_data)
#     assert response.status_code == 200
...
#     create_response = client_sqlite.post(f"{settings.API_V1_STR}/users/", json=user_data)
#     user_id = create_response.json()["id"]
#     response = client_sqlite.delete(f"{settings.API_V1_STR}/users/{user_id}")
#     assert response.status_code == 204
#     get_response = client_sqlite.get(f"{settings.API_V1_STR}/users/{user_id}")
